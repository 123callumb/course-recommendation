...
import MultiRadioQuestion_Comp from "../Question/MultiRadioQuestion";
...
export default class Section_Comp extends React.Component<SectionComp_Props> {
    ...
    MultiQuestion() {
        return <MultiRadioQuestion_Comp answers={this.props.section.Answers} answerSet={this.props.sectionAnswers} questions={this.props.section.Questions} sectionID={this.props.section.SectionID} />;
    }
