    ...
    render() {
        ...
        return <>
            ...
            {this.props.questions.map((e, i) => {
                return <RadioGroup key={this.props.sectionID + "_" + i} value={this.GetAnswerForQuestion(e.QuestionID)} onChange={(newVal: string) => this.props.SetAnswerSet(this.props.groupID, this.props.sectionID, parseInt(newVal), e.QuestionID) }>
